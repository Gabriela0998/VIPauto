...
public class FuelHelper { public static void setGridPane(GridPane gridPane) {
    ...
    public static void clearForm(GridPane gridPane, FuelEntity fuel, TextField idTF, TextField nameTF) {
        nameTF.clear();
        idTF.clear();
    }
}
