...
public class MotorVehicleHelper {
    ...
    public static void setGridPane(GridPane gridPane) {
        ...
        ColumnConstraints columnOneConstraints = new ColumnConstraints(250, 250, Double.MAX_VALUE);
        columnOneConstraints.setHalignment(HPos.RIGHT);

        ColumnConstraints columnTwoConstrains = new ColumnConstraints(450, 450, Double.MAX_VALUE);
    ...
    public static void clearForm(GridPane gridPane, MotorVehicleEntity motorVehicle, TextField idTF, TextField nameTF) {
        nameTF.clear();
        idTF.clear();
    }
    public static void comboView(GridPane gridPane, String nameComboBox, ComboBox combo){
        MotorVehicleService.getExistingMotorVehicleIdBrand(nameComboBox);
