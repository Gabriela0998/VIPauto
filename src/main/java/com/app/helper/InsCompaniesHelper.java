...
public class InsCompaniesHelper { public static void setGridPane(GridPane gridPane) {
    ...
    public static void clearForm(GridPane gridPane, InsCompaniesEntity insCompanies, TextField idTF, TextField nameTF, TextField phoneTF, TextField extraTF) {
        nameTF.clear();
        idTF.clear();
        phoneTF.clear();
        extraTF.clear();
