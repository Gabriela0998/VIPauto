...
public class TypeDocumentHelper { public static void setGridPane(GridPane gridPane) {
    ...
    public static void clearForm(GridPane gridPane, TypeDocumentEntity typeDocument, TextField idTF, TextField nameTF) {
        nameTF.clear();
        idTF.clear();
    }
}
