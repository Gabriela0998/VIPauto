...
public class TypeCostHelper { public static void setGridPane(GridPane gridPane) {
    ...
    public static void clearForm(GridPane gridPane, TypeCostEntity typeCost, TextField idTF, TextField nameTF) {
        nameTF.clear();
        idTF.clear();
    }
}
