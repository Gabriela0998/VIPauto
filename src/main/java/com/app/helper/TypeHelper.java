...
public class TypeHelper { public static void setGridPane(GridPane gridPane) {
    ...
    public static void clearForm(GridPane gridPane, TypeEntity type, TextField idTF, TextField nameTF) {
        nameTF.clear();
        idTF.clear();
    }
}
