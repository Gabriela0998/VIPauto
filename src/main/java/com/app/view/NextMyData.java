...
public class NextMyData {
    ...
    static public Integer itype;
    static public Integer iduser;
    static public int idMyData;

    public NextMyData(int type, int id_user) {
        ...
        if(type==2){
            ...
            itype=1;
            subStage.setTitle("Мойте данни");
        }

        //FlowPane root = new FlowPane();
        //root.setAlignment(Pos.CENTER);
        Scene scene = new Scene(createFormPane(), 700, 700);
    ...
    private void firmView(GridPane gridPane) {
        ...
        Button addButton = new Button("Продължение");
        Button exitButton = new Button("Изход");

        MyDataHelper.nextSearchSection(gridPane,  addButton, exitButton,
                "", 1, 14);
        ...
        addButton.setOnAction(e -> {
            try {
                onSubmit(gridPane, myData, nameTF, country, city, address, EIK, DDS, bank,
                        Iban, bic, manager, phone, place, iduser);
                //gridPane.add(getTableView(getFacultyInfo(false, null), gridPane), 1, 9);
    ...
    private void myDataView(GridPane gridPane) {
        Label headerLabel = new Label("Мойте данни");
        headerLabel.setFont(new Font("Arial", 26));
        ...
        //Faculty name label and text
        MyDataHelper.addLabel(gridPane, "Име: ", 0, 1);
        nameTF = MyDataHelper.addTextField(gridPane, "", 1, 1);
        //ValidationHelper.lettersOnly(nameTF, 200);

        //country label and text
        MyDataHelper.addLabel(gridPane, "Държава: ", 0, 4);
        country = MyDataHelper.addTextField(gridPane, "", 1, 4);
        //ValidationHelper.lettersOnly(country, 20);

        //city label and text
        MyDataHelper.addLabel(gridPane, "Град: ", 0, 5);
        city = MyDataHelper.addTextField(gridPane, "", 1, 5);
        //ValidationHelper.lettersOnly(city, 50);

        //address label and text
        MyDataHelper.addLabel(gridPane, "Адрес: ", 0, 6);
        address = MyDataHelper.addTextField(gridPane, "", 1, 6);
        //ValidationHelper.lettersOnly(address, 100);

        //EIK label and text
        MyDataHelper.addLabel(gridPane, "ЕГН: ", 0, 7);
        EIK = MyDataHelper.addTextField(gridPane, "", 1, 7);
        //ValidationHelper.lettersAndNumberOnly(EIK, 13);

        //DDS label and text
        MyDataHelper.addLabel(gridPane, "Доп. данни: ", 0, 8);
        DDS = MyDataHelper.addTextField(gridPane, "", 1, 8);
        //ValidationHelper.lettersAndNumberOnly(DDS, 15);

        //bank label and text
        MyDataHelper.addLabel(gridPane, "Банка: ", 0, 9);
        bank = MyDataHelper.addTextField(gridPane, "", 1, 9);
        //ValidationHelper.lettersOnly(bank, 50);

        //Iban label and text
        MyDataHelper.addLabel(gridPane, "IBAN: ", 0, 10);
        Iban = MyDataHelper.addTextField(gridPane, "", 1, 10);
        //ValidationHelper.lettersAndNumberOnly(Iban, 30);

        //bic label and text
        MyDataHelper.addLabel(gridPane, "BIC: ", 0, 11);
        bic = MyDataHelper.addTextField(gridPane, "", 1, 11);
        //bic.setText("Not Glowing");
        //ValidationHelper.lettersAndNumberOnly(bic, 10);

        //manager label and text
       MyDataHelper.addLabel(gridPane, "Презиме: ", 0, 2);
        manager = MyDataHelper.addTextField(gridPane, "", 1, 2);
        //ValidationHelper.lettersOnly(manager, 50);

        //place label and text
        MyDataHelper.addLabel(gridPane, "Фамилия: ", 0, 3);
        place = MyDataHelper.addTextField(gridPane, "", 1, 3);
        //ValidationHelper.lettersOnly(place, 50);
    ...
    private void onSubmit(GridPane gridPane, MyDataEntity myData, TextField nameTF, TextField country, TextField city,
                          ...
                          TextField Iban, TextField bic, TextField manager, TextField phone, TextField place, int id_user) throws ParseException {
        if (nameTF.getText().isEmpty()) {
            Helpers.showAlert(Alert.AlertType.ERROR, gridPane.getScene().getWindow(),
                    "Form Error!", "Не е попълнено име!");
            return;
        }
        if (EIK.getText().isEmpty()) {
            Helpers.showAlert(Alert.AlertType.ERROR, gridPane.getScene().getWindow(),
                    "Form Error!", "Не е попълнен ЕИК/Булстат/EГН!");
            return;
        }
    ...
    private void createUser(int id_user) {
